...
class Stats {
  ...
  int _ms = 0, _msMin = 1000, _msMax = 0, _fps = 0, _fpsMin = 1000, _fpsMax = 0, _frames = 0, _mode = 0;
  DivElement container, fpsDiv, msDiv, msText, msGraph, fpsGraph, fpsText;
  ...
  void _createUi() {
    ...
    while (fpsGraph.children.length < 74) {
      bar = new SpanElement()..style.cssText = 'width:1px;height:30px;float:left;background-color:#113';
      fpsGraph.append(bar);
    }
    ...
    while (msGraph.children.length < 74) {
      bar = new SpanElement()..style.cssText = 'width:1px;height:30px;float:left;background-color:#131';
      msGraph.append(bar);
    }
  }
